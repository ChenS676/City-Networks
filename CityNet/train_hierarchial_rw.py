"""
train_hierarchial_rw.py
--------------
Training, evaluation, and logging script for HierarchialRW link prediction.

Imports the model and method components from hierarchial_rw_model.py.
...
Usage:
    python train_hierarchial_rw.py --data_name "Cora" --data_root "data/Cora"
    python train_hierarchial_rw.py --data_name "CiteSeer" --data_root "data/CiteSeer"
"""
...
from hierarchial_rw_model import (
    MupConfig,
    Transformer,
    LinkPredictorMLP,
...
def get_config():
    parser = argparse.ArgumentParser(description="HierarchialRW Link Prediction on Planetoid data")
...
for epoch in range(config['num_epochs']):
    ...
    # ---- Sample a subset of train edges for evaluation (HierarchialRW style) ----
