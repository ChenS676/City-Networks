...
#         # Only Laplacian PE is supported; RWSE has been removed.
...
#     # Laplacian PE only — RWSE removed
...
#             CustomLaplacianPE(max_freq=config["pe_dim"], normalized=True, normalize=True)
#         )
...
#         f"PE-{'lap' if config['use_pe'] else 'none'}_"
